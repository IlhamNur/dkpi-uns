<nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto <?php echo e(($title === "About") ? 'active' : ''); ?>" href="/home/about">About Us</a></li>
          <li><a class="bi bi-box-arrow-in-right" href="/login"></a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->
<?php /**PATH C:\Users\ilham\Downloads\Compressed\dkpi\dkpi-uns\resources\views/partials/navbar.blade.php ENDPATH**/ ?>