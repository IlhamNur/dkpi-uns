                ...
                <?php endif; ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br/><br/>
                            <p class="card-text">Keterangan : <?php echo $gallery->caption; ?></p>
                            <p class="card-text">Tanggal Dibuat : <?php echo e($gallery->created_at); ?></p>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dkpiuns/dkpi-uns/resources/views/gallery/show.blade.php ENDPATH**/ ?>