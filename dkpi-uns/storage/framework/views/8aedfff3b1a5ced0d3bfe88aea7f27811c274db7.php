...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group ml-5 mr-5">
                            ...
                            <textarea class="form-control  <?php $__errorArgs = ['pengumuman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="editor" id="pengumuman" placeholder="Isi Pengumuman" name="pengumuman" value="<?php echo e(old('pengumuman')); ?>">
                          	</textarea>
...
unset($__errorArgs, $__bag); ?>" id="link" placeholder="tautan" name="link" value="<?php echo e(old('link')); ?>">
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dkpiuns/dkpi-uns/resources/views/pengumuman/create.blade.php ENDPATH**/ ?>