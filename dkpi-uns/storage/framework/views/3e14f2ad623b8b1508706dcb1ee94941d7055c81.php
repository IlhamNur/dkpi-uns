...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="row">
          <div class="form-group col-md-6">
            <label for="name">Telepon Anda</label>
            <input type="tel" class="form-control" name="phone" id="phone" min="8" required>
...
<?php /**PATH C:\Users\ilham\Documents\Internship\dkpi-uns\dkpi-uns\resources\views/contact/contact.blade.php ENDPATH**/ ?>