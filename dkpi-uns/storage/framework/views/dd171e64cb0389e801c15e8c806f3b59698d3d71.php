    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?php echo $pengumuman->pengumuman; ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dkpiuns/dkpi-uns/resources/views/home/pengumumandetails.blade.php ENDPATH**/ ?>