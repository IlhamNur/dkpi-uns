        ...
        <div class="row" data-aos="fade-up">
            ...
            <div class="col-xl-4 stretch-card">
                <div class="card bg-light text-black" data-aos="zoom-in" data-aos-delay="200">
                    <div class="card-body">
                        <h2 data-aos="zoom-in" data-aos-delay="300">Terbaru</h2>
                        <div class="icon-box border-bottom-blue pt-3 pb-4" data-aos="zoom-in" data-aos-delay="400">
                            <div class="pr-3">
                                <?php
                                    $peng = DB::table('pengumumen')->latest()->first();
                                ?>
                                <a href="/home/pengumumandetails/<?php echo e($peng->id); ?>"><h5 ml-2><?php echo e($peng->judul); ?></h5></a>
                                <div class="fs-12">
                                    <span class="mr-2"><?php echo e(\Carbon\Carbon::parse($peng->created_at)->diffForHumans()); ?></span>
                                </div>
                            </div>
                        </div>

                        <div class="icon-box border-bottom-blue pb-4 pt-4" data-aos="zoom-in" data-aos-delay="500">
                            <div class="pr-3">
                                <a href="/home/berita/beritadetails/<?php echo e($beritas[count($beritas)-1]->id); ?>"> <h5><?php echo e($beritas[count($beritas)-1]->judul); ?></h5></a>
                                <div class="fs-12">
                                    <span class="mr-2"><?php echo e($beritas[count($beritas)-1]->created_at->diffForHumans()); ?> </span>
                                </div>
                            </div>
                        </div>

                        <div class="icon-box border-bottom-blue pt-4" data-aos="zoom-in" data-aos-delay="600">
                            <div class="pr-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilham\Downloads\Compressed\dkpi\dkpi-uns\resources\views/home/index.blade.php ENDPATH**/ ?>