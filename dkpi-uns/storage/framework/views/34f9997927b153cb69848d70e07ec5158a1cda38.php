...
<section id="breadcrumbs" class="breadcrumbs" style="background-color: #fff">
    <div class="container">
        ...
        <h2 class="text-capitalize">Detail Galeri</h2>
                ...
                <div class="portfolio-details-slider swiper-container">
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="">
                            ...
                            <center><iframe width="650" height="370" src="<?php echo e($galeri->link); ?>" title="YouTube video player" frameborder="0" 
                ...
                <div class="portfolio-info" style="background-color: rgb(248, 248, 248)">
                    ...
                    <ul>
                        ...
                        <li><strong>Link</strong>: <a
                                href="<?php echo e($galeri->link); ?>"><?php echo e($galeri->link); ?></a></li>
                    </ul>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dkpiuns/dkpi-uns/resources/views/home/galeridetails.blade.php ENDPATH**/ ?>