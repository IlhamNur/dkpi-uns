...
<form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="/pengumuman">
    <div class="form-group mb-0">
        <div class="input-group input-group-alternative input-group-merge">
            ...
            <input class="form-control" placeholder="Search" type="text" name="pengumuman"
                value="<?php echo e(request('pengumuman')); ?>">
        </div>
    </div>
        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="/pengumuman/create" class="btn btn-sm btn-neutral">Baru</a>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td><?php echo $pengumuman->pengumuman; ?></td>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dkpiuns/dkpi-uns/resources/views/pengumuman/index.blade.php ENDPATH**/ ?>