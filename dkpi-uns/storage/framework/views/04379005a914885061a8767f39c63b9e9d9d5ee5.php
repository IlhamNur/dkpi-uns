         ...
         <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="/pdln">
          <div class="form-group mb-0">
            <div class="input-group input-group-alternative input-group-merge">
              ...
              <input class="form-control" placeholder="Cari" type="text" name="nama" value="<?php echo e(request('nama')); ?>">
            </div>
          </div>
  ...
  <div class="col-xl-3 col-md-6">
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">Data</h5>
            <span class="h2 font-weight-bold mb-0">PDLN</span>
          </div>
          <div class="col-auto">
    ...
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">Data</h5>
            <span class="h2 font-weight-bold mb-0">Mitra</span>
          </div>
          <div class="col-auto">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    ...
                    <span class="h2 font-weight-bold mb-0">Universitas</span>
                  </div>
                  <div class="col-auto">
            ...
            <div class="card card-stats">
              <!-- Card body -->
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Tanya Jawab</h5>
                        <span class="h2 font-weight-bold mb-0">Umum</span>
                      </div>
                      <div class="col-auto">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                      ...
                      <a class="text-nowrap text-success" href="/faq">Pertanyaan yang Umum Ditanyakan</a>
                    </p>
                  </div>
                   <!-- END Card body -->
              </div>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilham\Documents\Internship\dkpi-uns\dkpi-uns\resources\views/dashboard/index.blade.php ENDPATH**/ ?>