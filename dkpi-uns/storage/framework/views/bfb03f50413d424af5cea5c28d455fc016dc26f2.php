              ...
              <div class="row">
                <div class="col-1">
                  <ol class="list-group list-group-numbered">
                    <h3><span class="badge" style="background-color: rgba(108, 88, 179, 0.75)"><?php echo e($keterangan -> id); ?></span></h3>
                  </ol>
                </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6 mb-3">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="q<?php echo e($penilaian_kepuasan->id); ?>" id="<?php echo e($keterangan -> id); ?>" value="<?php echo e($keterangan ->keterangan); ?>">
                  <label class="form-check-label" for="<?php echo e($keterangan -> id); ?>"><?php echo e($keterangan -> id); ?></label><br><br>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilham\Documents\Internship\dkpi-uns\resources\views/home/layanan/surveykepuasan.blade.php ENDPATH**/ ?>