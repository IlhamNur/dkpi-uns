                ...
                <div class="card">
                    ...
                    <form method="POST" action="/pengumuman/{{ $pengumuman->id }}">
                        ...
                        <div class="form-group ml-5 mr-5">
                            ...
                            <textarea id="editor" class="form-control  @error('pengumuman') is-invalid @enderror" id="pengumuman" placeholder="Isi Pengumuman" name="pengumuman" value="{{ old('pengumuman', $pengumuman->pengumuman) }}">
                          </textarea>
                            @error('pengumuman')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="form-group ml-5 mr-5">
                            ...
                            <input type="text" class="form-control  @error('link') is-invalid @enderror" id="link" placeholder="tautan" name="link" value="{{ old('link', $pengumuman->link) }}">
                            @error('link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
