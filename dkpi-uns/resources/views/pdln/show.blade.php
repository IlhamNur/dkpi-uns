                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="download/uns/{{ $pdln->id }}" class="btn btn-warning">Unduh Surat UNS</a>
                            @endif</div>
                            <div class="col-md mt-2">
                            @if($pdln->file_belmawa != 'null')
                            <a href="download/belmawa/{{ $pdln->id }}" class="btn btn-warning">Unduh Surat
                                Belmawa</a>
                            @endif</div>
                            <div class="col-md mt-2">
                            @if($pdln->file_ktln != 'null')
                            <a href="download/ktln/{{ $pdln->id }}" class="btn btn-warning">Unduh Surat KTLN</a>
                            @endif</div>
                        </div>
                        <br>
