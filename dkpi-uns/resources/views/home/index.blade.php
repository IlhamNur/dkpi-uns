                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{$key == 0 ? 'active' : '' }}">
                                <img src="{{asset('storage/'. $header->gambar )}}" class="d-block w-100" alt="...">
                              	<h2 class="bottom-left">{{ $header->nama }}</h2>
                            </div>
                            @endforeach
                ...
                <div class="card bg-light text-black" data-aos="zoom-in" data-aos-delay="200">
                    <div class="card-body">
                        ...
                        <div class="icon-box border-bottom-blue pt-3 pb-4" data-aos="zoom-in" data-aos-delay="300">
                            @foreach($pengumumans->take(1) as $peng)
                          	<div class="pr-3">
                                <a href="/home/pengumumandetails/{{ $peng->id }}"><h5 ml-2>{{ substr($peng->judul, 0, 60)."..." }}</h5></a>
                                <div class="fs-12">
                                    <span class="mr-2">{{ $peng->created_at->diffForHumans() }}</span>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="icon-box border-bottom-blue pb-4 pt-4" data-aos="zoom-in" data-aos-delay="400">
                            @foreach($beritas->take(1) as $ber)
                          	<div class="pr-3">
                                <a href="/home/berita/beritadetails/{{ $ber->id }}"> <h5>{{ substr($ber->judul, 0, 60)."..." }}</h5></a>
                                <div class="fs-12">
                                    <span class="mr-2">{{ $ber->created_at->diffForHumans() }} </span>
                                </div>
                            </div>
                          	@endforeach
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{!! substr($berita->excerpt, 0, 200)."..." !!}
